...
class CFSDesign:
    ...
    @staticmethod
    def calculate_effective_width(w: float, t: float, f: float, E: float = 203000.0) -> float:
        """
    ...
    @staticmethod
    def design_column_capacity(A: float, r: float, L: float, fy: float, E: float = 203000.0) -> float:
