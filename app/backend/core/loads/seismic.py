...
def calculate_seismic_loads(inp: SeismicInput) -> SeismicResult:
    ...
    for i in range(len(inp.floor_weights_kn)):
        ...
        story_forces.append(SeismicStoryForce(
            floor=i,
            elevation_m=round(inp.floor_elevations_m[i], 2),  # pyre-ignore[6]
            weight_kn=round(inp.floor_weights_kn[i], 2),  # pyre-ignore[6]
            force_kn=round(Fx, 2),  # pyre-ignore[6]
    ...
    for i in reversed(range(len(story_forces))):
        ...
        story_forces[i].shear_kn = round(cumulative_shear, 2)  # pyre-ignore[6]
    ...
    return SeismicResult(
        ...
        S=S,
        R=R,
        T=round(T, 3),  # pyre-ignore[6]
        Cs=round(Cs, 4),  # pyre-ignore[6]
        W=round(W, 2),  # pyre-ignore[6]
        base_shear_kn=round(V, 2),  # pyre-ignore[6]
        overturning_moment_knm=round(overturning_moment, 2),  # pyre-ignore[6]
